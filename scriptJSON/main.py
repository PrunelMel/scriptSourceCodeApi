...
"""
#conversion des listes obtenues en donnees json
"""list_dep = json.dumps(list_dep)
list_com = json.dumps(list_com)
list_arr = json.dumps(list_arr)
list_vq = json.dumps(list_vq)
print(list_dep)
#print(list_com)
#print(list_arr)
#print(list_vq)
